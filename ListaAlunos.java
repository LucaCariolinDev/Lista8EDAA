...
public class ListaAlunos {
	...
	public void InserirAlunoPrimeiraPosicao(Aluno p) {
		if(buscarAluno(p.getMatricula()) == null) {
			this.Lista_Alunos[0] = p;
			System.out.println("Aluno inserido com sucesso na primeira posição");
		}
		else {
			System.out.println("Aluno com mátricula informada já cadastrado");
		}
	...
	public void InserirAlunoUltimaPosicao(Aluno p) {
		if(buscarAluno(p.getMatricula()) == null) {
			this.Lista_Alunos[Lista_Alunos.length - 1] = p;
			System.out.println("Aluno inserido com sucesso na última posição");
		}
		else {
			System.out.println("Aluno com mátricula informada já cadastrado");
		}
	...
	public void LimparLista() {
		this.Lista_Alunos = new Aluno[this.Lista_Alunos.length];
	}
